...
- The action history and current values and effect on the progress bar do not match up when I use the !shave or !beard command in twitch chat to trigger points being added to the progress bar.

Example: Added 500 points via 500 bits, then used the !shave command. I now see +500 shave in the Action History, but the Total Beard Points is 500 and Total Save Points is 0 and the progress bar moved so the beard side has more points now.
...
### Create bug report
```
Record your notes about the bug in a new file inside ai-specs\04-05_01_progress-bar-configs\generated\bugs\ 
- Located the ai-specs\04-05_01_progress-bar-configs\generated\bugs folder in the same directory as the prd file
- Find the highest bug number folder in the ai-specs\04-05_01_progress-bar-configs\generated\bugs folder
...
- CREATE the new folder with that name in ai-specs\04-05_01_progress-bar-configs\generated\bugs\
